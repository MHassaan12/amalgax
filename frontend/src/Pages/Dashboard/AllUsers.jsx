...
import { allUsers } from '../../store/state/adminSlice';

function AllUsers({ userId, color = 'light' }) {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        Header: 'INDIRECT MEMBERS',
        accessor: 'package.indirect_members',
      },
      {
    ...
    <>
      ...
      >
        ...
        <div className="block w-full overflow-x-auto">
          {/* Projects table */}
          {!loading && <Tables columns={columns} data={users} color={color} />}
        </div>
      </div>
    </>
  )
